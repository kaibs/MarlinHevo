...
#define STRING_CONFIG_H_AUTHOR "kaibs" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // HEVO brass block 24V
  #define DEFAULT_Kp 15.65
  #define DEFAULT_Ki 0.85
  #define DEFAULT_Kd 71.79
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 33.61
  #define DEFAULT_bedKi 6.27
  #define DEFAULT_bedKd 120.22
...
//new 1mm pitch leadscrews
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 3200, 418 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.04 // (mm) Distance from real junction edge -> 0.4*(jerk^2/accel)
...
#define XY_PROBE_SPEED 2200

// Feedrate (mm/m) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_SPEED_FAST 1100

// Feedrate (mm/m) for the "accurate" probe of each point
#define Z_PROBE_SPEED_SLOW 1100
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY 3600
#define HOMING_FEEDRATE_Z  14*50
